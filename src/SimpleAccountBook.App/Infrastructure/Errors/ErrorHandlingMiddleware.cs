...
namespace SimpleAccountBook.App.Infrastructure.Errors
{
    public class ErrorHandlingMiddleware
    {
            ...
            IStringLocalizer<ErrorHandlingMiddleware> localizer)
        {
            ...
            switch (exception)
            {
                case HttpStatusException re:
                    context.Response.StatusCode = (int)re.StatusCode;
                    result = JsonSerializer.Serialize(re.Data);
                    break;
                case Exception e:
                    context.Response.StatusCode = (int)HttpStatusCode.InternalServerError;
                    logger.LogError(e, "Unhandled Exception");
                    result = JsonSerializer.Serialize(new ApiErrorModel
                    {
